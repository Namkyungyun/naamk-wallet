...
abstract class $AppErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic show, dynamic code, dynamic message});
}
...
class _$AppErrorImpl implements _AppError {
  const _$AppErrorImpl({this.show = false, this.code = '', this.message = ''});
  ...
  @override
  String toString() {
    return 'AppError(show: $show, code: $code, message: $message)';
  }
...
abstract class _AppError implements AppError {
  const factory _AppError(
      {final dynamic show,
      final dynamic code,
      final dynamic message}) = _$AppErrorImpl;
